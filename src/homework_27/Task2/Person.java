...
public class Person {
    ...
    public void setPassword(String password) {
        if (isPassordValid(password))
            
        this.password = password;
    }

    private boolean isPassordValid(String password) {
        ...
        for (int i = 0; i < password.length(); i++) {
            ...
            if (Character.isLowerCase(ch)) {
                ...
                isSpesialSympol = true;
            }
        }
            return isLowerCase && isUpperCase && isDigit && isSpesialSympol;
